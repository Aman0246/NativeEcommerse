...
export default function Main() {
  ...
  return (
    <>
      ...
      {/* //MOdels -----------!-> ----// Add event listener for the back button press
  const backHandler = BackHandler.addEventListener('hardwareBackPress', backAction);  ----------------------setModalVisible------------------/ */}
        ...
        <View style={{ position: "absolute", bottom: 0, width: "100%" }}>
          ...
          >
            ...
            >
              <Pressable
                style={({ pressed }) => [
                  { opacity: pressed ? 0.5 : 1 }, // Apply opacity when pressed
                  {
                    flexDirection: "column",
                    justifyContent: "center",
                    alignItems: "center",
